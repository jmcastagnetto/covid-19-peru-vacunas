...
frictionless validate --schema schemas/covid19_vaccine_arrivals_peru-schema.yaml datos/covid19_vaccine_arrivals_peru.csv
...
frictionless validate --schema schemas/vacunas_covid_totales_fabricante_ubigeo-schema.yaml datos/vacunas_covid_totales_fabricante_ubigeo.csv
...
frictionless validate --schema schemas/vacunas_covid_vacunafests-schema.yaml datos/vacunas_covid_vacunafests.csv 
frictionless validate --schema schemas/vacunas_covid_vacunatones-schema.yaml datos/vacunas_covid_vacunatones.csv
